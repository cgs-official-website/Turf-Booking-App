...
export default function Subscriptions() {
  ...
  return (
    <div className="sub-page">
        ...
        {/* ── Tabs
              Desktop/mobile : SUBSCRIPTION | PLAN MANAGEMENT
              Tablet          : same tabs + Edit plans btn at the far right ── */}
        <div className="sub-page__tabs">
          ...
          {/* Tablet-only: Edit plans button lives in the tab bar (image 7) */}
          {activeTab === "plan" && (
            <button
        ...
        {activeTab === "plan" && (
          <div className="sub-plan-management">
            ...
            {/* Desktop / mobile standalone header with Edit plans btn.
                Hidden on tablet via CSS (tab bar hosts the btn there). */}
            ...
            {/* ── Mobile radio-pill plan selector ──
                Shown only on ≤640px via CSS.
                ALL plans shown as scrollable radio buttons */}
            <div className="sub-plan-tabs">
              {plans.map((p, i) => (
                ...
                >
                  ...
                  {/* Short label: strip " plan" / " Plan" suffix */}
            ...
            {/* ── Plan cards row ──
                Desktop/Tablet: scrollable horizontal layout
                Mobile: single card (controlled by planTabIndex) ── */}
              ...
              <div className="sub-plan-management__scroll-wrapper">
                <div className="sub-plan-management__grid">
                  {plansLoading ? (
                    ...
                    // Show ALL plans in a scrollable horizontal row on desktop/tablet
                    // Mobile: only show the selected one
                    plans.map((p, i) => (
                      <div
                        key={p.id}
...
//             {/* ── Plan cards row ──
//                 Desktop : left/right arrows + 3-up grid
//                 Tablet  : 3-up grid, no arrows needed
//                 Mobile  : single card (controlled by planTabIndex) ── */}
//             <div className="sub-plan-management__row">
//               {safeStartIndex > 0 && (
//                 <button
...
//                   <p>Loading plans...</p>
//                 ) : plans.length > 0 ? (
//                   // Show ALL plans in the grid, but only show the selected one on mobile
//                   plans.map((p, i) => (
//                     /* plan-card--visible is read by the mobile CSS to show
//                        only the card whose index matches planTabIndex */
//                     <div
//                       key={p.id}
//                       className={i === planTabIndex ? "plan-card--visible" : ""}
//                     >
//                       <PricingCard
//                         plan={p}
//                         showAdminControls={false}
...
// //             {/* ── Mobile radio-pill plan selector (images 3–5) ──
// //                 Shown only on ≤640px via CSS.
// //                 Each button selects which single card is shown below. */}
// //             <div className="sub-plan-tabs">
