      ...
      <div className="vendor-stats-grid">
        ...
        <div className="vendor-stat-card">
          <div className="vendor-stat-content">
            ...
            <p className="vendor-stat-growth">{stats.expiringSoon > 0 ? `⚠️ ${stats.expiringSoon} expiring soon` : "All good"}</p>
          </div>
        ...
        <div className="vendor-stat-card">
          <div className="vendor-stat-content">
            <h3>Expired</h3>
            <h2>{stats.expired}</h2>
            <p className="vendor-stat-growth negative-growth">{stats.expired > 0 ? `⚠️ ${stats.expired} expired` : "All active"}</p>
          </div>
