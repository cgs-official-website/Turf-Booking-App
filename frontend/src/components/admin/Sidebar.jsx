...
const navItems = [
  { id: "dashboard",       label: "Dashboard",         path: "/admin/dashboard",       icon: <MdDashboard /> },
  { id: "vendors",         label: "Vendor management", path: "/admin/vendors",         icon: <MdPeople /> },
  { id: "subscriptions",   label: "Subscription",      path: "/admin/subscriptions",   icon: <MdCreditCard /> },
  { id: "turfs",           label: "Turf approvals",    path: "/admin/turfs",           icon: <MdCheckCircle /> },
  { id: "bookings",        label: "Bookings",          path: "/admin/bookings",        icon: <MdCalendarToday /> },
  { id: "payment-history", label: "Payment history",   path: "/admin/payment-history", icon: <MdPayment /> },
  { id: "reports",         label: "Reports",           path: "/admin/reports",         icon: <MdBarChart /> },
  { id: "settings",        label: "Settings",          path: "/admin/settings",        icon: <MdSettings /> },
];
...
//     path: "/admin/turfs",            // ✅ FIXED: was /admin/turf-approvals
//     icon: (
//       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
//     id: "notifications",
//     label: "Notifications",
//     path: "/admin/notifications",    // ✅ FIXED: was /admin/payment-history
//     icon: (
//       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
//     id: "profile",
//     label: "Profile",
//     path: "/admin/profile",          // ✅ FIXED: was /admin/reports
//     icon: (
//       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//         <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
//         <circle cx="12" cy="7" r="4" />
