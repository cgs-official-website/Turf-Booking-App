// VendorDetail.jsx - Updated with full backend integration
  ...
  return (
    <div className="vendor-detail-container">
      ...
      <div className="stats-grid">
        ...
        {/* Subscription - Dynamic based on status (compact) */}
        <div className={`subscription-card ${vendorData.isSubscriptionActive ? 'active' : 'expired'}`}>
          <div className={`stat-icon-circle ${vendorData.isSubscriptionActive ? 'green' : 'muted'}`}>
            <svg width="50" height="50" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <foreignObject x="-12" y="-12" width="64" height="64">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ backdropFilter: 'blur(6px)', clipPath: 'url(#bgblur_0_2753_16425_clip_path)', height: '100%', width: '100%' }} />
              </foreignObject>
              ...
              <defs>
                <clipPath id="bgblur_0_2753_16425_clip_path" transform="translate(12 12)">
