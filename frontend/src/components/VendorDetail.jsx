    ...
    if (vendor) {
      ...
      try {
        ...
        if (vendor.subscription) {
          ...
          subscription = isSubscriptionActive ? 'Active' : 'Expired';
          subscriptionPlan = vendor.subscriptionPlan || 'Unknown Plan';
        ...
        const newData = {
          ...
          totalTurfs: String(transformedTurfs.length), // FIXED: Removed .padStart(2, '0')
          newTurfs: '+0 New',
...
<div className="stats-grid">
  ...
  <div className="stat-card">
    ...
    <div className="stat-content">
      ...
      <div className="stat-value">{vendorStats.activeBookings ?? 0}</div> {/* FIXED: Removed .padStart */}
    </div>
  </div>
      ...
      <div className="bottom-sections">
        <div className="recent-bookings">
          <h3 className="section-title">
            <span className="section-icon-circle star"><svg
  viewBox="0 0 24 24"
  fill="none"
  stroke="currentColor"
  strokeWidth="2"
